/**
 * AIPanel — AI Assistant as a layout panel tab.
 * Wraps AIChat internals (messages, input, conversations, templates)
 * for use as a resizable panel instead of a fixed overlay.
 */
