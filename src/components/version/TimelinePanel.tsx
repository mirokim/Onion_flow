...
/** Embeddable timeline content (no panel wrapper) */
    ...
    <>
          ...
          {showInput ? (
            <div className="flex gap-2">
              <input
                ...
                placeholder="스냅샷 이름..."
                autoFocus
                className="flex-1 text-sm px-2 py-1.5 rounded bg-bg-secondary border border-border outline-none focus:border-blue-500"
              />
              <button
              ...
              <button
                ...
                className="text-xs px-2 py-1.5 rounded bg-bg-hover hover:bg-bg-hover/80 transition-colors"
              >
                취소
              </button>
            </div>
            ...
            <button
              ...
              className="w-full text-sm px-3 py-2 rounded border border-dashed border-border hover:border-blue-500 hover:bg-blue-500/5 transition-colors flex items-center justify-center gap-2 text-text-secondary"
            >
        ...
        <div className="flex-1 overflow-y-auto">
          {loading ? (
            ...
            <div className="text-center py-12">
              <History className="w-8 h-8 text-text-secondary mx-auto mb-3 opacity-30" />
      ...
      {confirmRestore && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50">
          <div className="bg-bg-surface border border-border rounded-xl shadow-xl w-[400px] p-5">
            ...
            <div className="flex justify-end gap-2 mt-5">
              <button
                ...
                disabled={restoring}
                className="text-xs px-3 py-1.5 rounded bg-bg-hover hover:bg-bg-hover/80 transition-colors"
              >
                취소
              </button>
              <button
